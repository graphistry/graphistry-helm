...
``ForgeMaxFileWait``                               milliseconds to wait for file creation                                                               ``"10000"``                                       
``FepDevMode``                                                                                                                                          ``false``                                         
``HypercornOpts``                                                                                                                                       ``null``                                          
...
``dask.operator``                                  enables dask operator                                                                                ``false``                                         
...
``vgpu``                                           enables vgpu mode for bigger than memory workloads on VGPU                                           ``false``                                         
...
``ProxyBodySize``                                  sets the proxy body size for ingress controller and uploads to 20 GB                                 ``"20000m"``                                      
...
``global.containerregistry.name``                  container registry name                                                                              ``"docker.io/graphistry"``                        
